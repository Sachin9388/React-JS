            ...
            <>
                <div className='container'>
                    ...
                    <form>
                        ...
                        <input type='text' onChange={(event) => { this.setState((prevState) => ({ formData: { ...prevState, [event.target.name]: event.target.value } })) }} name='uname' id='uname' />

                        <br />
                        <br />

                        <input type='text' onChange={(event) => { this.setState((prevState) => ({ formData: { ...prevState, [event.target.name]: event.target.value } })) }} name='password' id='password' />
